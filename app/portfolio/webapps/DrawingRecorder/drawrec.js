$(function () {
    ...
    var tempDetails = "";
    var playInterval = 5;   //recording/playing interval - miliseconds
        ...
        if (localStorage.unnamed) {
            ...
            for (var o in localStorage) {
                try{
                    ...
                    console.error(o + " can't be parsed as JSON");
                };
            }
    ...
    function replay() {
        ...
        //start drawing
        interval = setTimeout(function replayExecution() {
            ...
            if (j === recordObj.recordArray.length - 1) {
                ...
                setTimeout(replayExecution, playInterval);
            }
